...
tests = [ {'description': 'PIND: 0x00, PINB: 0x00 => PORTB: 0x00',
    ...
    {'description': 'PIND: 0x80, PINB: 0x01 => PORTB: 0x02',
    'steps': [ {'inputs': [('PIND',0x80),('PINB',0x01)], 'iterations': 1 } ],
    'expected': [('PORTB',0x02)],
    },
    {'description': 'PIND: 0x66, PINB: 0x00 => PORTB: 0x02',
    'steps': [ {'inputs': [('PIND',0x66),('PINB',0x00)], 'iterations': 1 } ],
    'expected': [('PORTB',0x02)],
    },
    {'description': 'PIND: 0x15, PINB: 0x01 => PORTB: 0x04',
    'steps': [ {'inputs': [('PIND',0x15),('PINB',0x01)], 'iterations': 1 } ],
    'expected': [('PORTB',0x04)],
    },
    ...
    'steps': [ {'inputs': [('PIND',0x23),('PINB',0x01)], 'iterations': 1 } ],
    'expected': [('PORTB',0x02)],
    },
